...
const zhCN = {
  ...
  init: {
    ...
    mcp: {
      ...
      aceToolRsPaid: '更轻量',
      skipLater: '稍后手动配置',
      skipTokenPrompt: '是否跳过 Token 配置？（可稍后运行 npx ccsm config mcp 配置）',
      skipKeyPrompt: '是否跳过 API Key 配置？（可稍后运行 npx ccsm config mcp 配置）',
    ...
    workflows: {
      dev: '主路径工作流 (/ccsm:spec-impl)',
      frontend: 'OpenSpec 初始化 (/ccsm:spec-init)',
      backend: '需求研究 (/ccsm:spec-research)',
      review: '验收审查 (/ccsm:spec-review)',
      analyze: '执行规划 (/ccsm:team-plan)',
      commit: 'Git 智能提交 (/ccsm:commit)',
      rollback: 'Git 回滚 (/ccsm:rollback)',
      cleanBranches: '清理分支 (/ccsm:clean-branches)',
      worktree: 'Worktree 管理 (/ccsm:worktree)',
      init: '项目初始化 (/ccsm:init)',
    },
    aceTool: {
  ...
  update: {
    ...
    willNotUpdateCli: '注意：这不会更新 ccsm CLI 本身',
  ...
  menu: {
    ...
    uninstall: {
      ...
      confirm: '确定要卸载 CCSM 吗？这将强制移除所有命令目录、配置文件和数据。',
...
const en: typeof zhCN = {
  ...
  cli: {
    help: {
      ...
      commandDescriptions: {
        ...
        initConfig: 'Initialize the CCSM workflow system',
  ...
  init: {
    welcome: 'Welcome to the CCSM workflow system',
    ...
    mcp: {
      ...
      skipTokenPrompt: 'Skip Token configuration? (run npx ccsm config mcp later)',
      skipKeyPrompt: 'Skip API Key configuration? (run npx ccsm config mcp later)',
    ...
    workflows: {
      dev: 'Primary workflow (/ccsm:spec-impl)',
      frontend: 'OpenSpec init (/ccsm:spec-init)',
      backend: 'Spec research (/ccsm:spec-research)',
      review: 'Acceptance review (/ccsm:spec-review)',
      analyze: 'Execution planning (/ccsm:team-plan)',
      commit: 'Git smart commit (/ccsm:commit)',
      rollback: 'Git rollback (/ccsm:rollback)',
      cleanBranches: 'Clean branches (/ccsm:clean-branches)',
      worktree: 'Worktree management (/ccsm:worktree)',
      init: 'Project initialization (/ccsm:init)',
    },
    aceTool: {
  ...
  update: {
    ...
    willNotUpdateCli: 'Note: This will not update the ccsm CLI itself',
  ...
  menu: {
    title: 'CCSM Main Menu',
    options: {
      init: 'Initialize CCSM configuration',
      ...
      uninstall: 'Uninstall CCSM',
      help: 'Help',
      exit: 'Exit',
    },
    help: {
      title: 'CCSM Commands:',
      hint: 'For more information, run: npx ccsm --help',
      sections: {
    ...
    uninstall: {
      ...
      confirm: 'Are you sure you want to uninstall CCSM? This will force remove all command directories, config files and data.',
      ...
      runInNewTerminal: 'Please run in a new terminal window:',
      afterDone: 'After completion, the ccsm command will be fully removed',
    },
  },
}
